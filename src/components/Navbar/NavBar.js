  ...
  const renderMobileMenu = (
    ...
    >
      <MenuItem>
        ...
        >
          <Typography variant="caption" className={classes.menuButtonText}>
            Help
          </Typography>
        </Button>
      </MenuItem>
              ...
              >
                <Paper>
                  <ClickAwayListener onClickAway={handleClose}>
                    ...
                    >
                      <MenuItem disabled>
                        <SmbText>Image Editor</SmbText>
                      </MenuItem>
                      <MenuItem
                        onClick={() => {
                          window.location.assign(VIDEO_EDITOR_URI);
                        }}
                      >
                        <SmbText>Video Editor</SmbText>
                      </MenuItem>
                    </MenuList>
                  </ClickAwayListener>
                </Paper>
