...
import ElementsPicker, {
  ELEMENT_TRAY_TYPE,
  ELEMENT_SUB_TYPE,
} from "./ElementsPicker/ElementsPicker";
  ...
  const onImageLoaded = (loadedImage = image, loadedImageUrl = imgUrl) => {
    ...
    setLayer((prev) => {
      ...
      if (loadedImageUrl.type === ELEMENT_SUB_TYPE.BACKGROUND_IMAGE) {
        ...
        loadedImageUrl.type === ELEMENT_SUB_TYPE.IMAGE ||
        ...
        if (
          ...
          if (
            ...
            copyLayer.width =
              ((stageHeight * 0.8) / loadedImage.naturalHeight) *
              loadedImage.naturalWidth;
            copyLayer.x =
              loadedImageUrl.type === ELEMENT_SUB_TYPE.DRAG_IMAGE
                ? copyLayer.x
            ...
            copyLayer.height =
              ((stageWidth * 0.8) / loadedImage.naturalWidth) *
              loadedImage.naturalHeight;
            copyLayer.y =
              loadedImageUrl.type === ELEMENT_SUB_TYPE.DRAG_IMAGE
                ? copyLayer.y
          ...
          data: `<div id="container" xmlns="http://www.w3.org/1999/xhtml" style="
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <span style="color: ${
                                          json.children[i].color
                                        };">${json.children[i].text}</span>
                                    </p>
                                </div>
      ...
      fetch(APILINK + URI.LOADDESIGN + projectId, {
        ...
        .then(
          (result) => {
            ...
            const details = getOffsetWidthAndHeight(
              "#editable-div",
              json.stageSize.stageWidth,
              json.stageSize.stageHeight
            );
  ...
  const handleCropSave = (crop, cropper) => {
    ...
    setLayer((prev) => {
      ...
      if (!(groupIndex > 0)) {
        ...
        const childElements = [...layerArr[groupIndex].childElements];
    ...
    <React.Fragment>
      ...
      <div className="design-section">
        ...
        <EditableDiv
          ...
          handleCropStart={(index, groupIndex) =>
            handleCropStart(index, groupIndex)
          }
        ...
        {!elementsPickerOpen && (
          <button
            className="open-menu"
            onClick={() => handlesElementsPickerState()}
          >
